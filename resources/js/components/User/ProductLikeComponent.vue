...
export default {
    ...
    created() {
        this.getLikedProduct(); // サーバから商品情報を取得
    ...
    methods: {
        ...
        getLikedProduct() {
            ...
            axios.get('/api/user/products/liked').then(response => {
        ...
        async getProducts(page) {
            try {
                ...
                const result = await axios.get('/api/user/products/liked' + `?page=${this.currentPage}`);
