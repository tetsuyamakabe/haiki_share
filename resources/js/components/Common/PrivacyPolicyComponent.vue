<template>
    <main class="l-container">
        ...
        <div class="l-container__inner">
            ...
            <section class="c-section">
                <h2 class="c-heading">第1条（個人情報）</h2>
                <div class="c-text">
                    <p>「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
                </div>
            </section>
            <section class="c-section">
                <h2 class="c-heading">第2条（個人情報の収集方法）</h2>
                <div class="c-text">
                    <p>当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。</p>
                </div>
            </section>
            <section class="c-section">
                <h2 class="c-heading">第3条（個人情報を収集・利用する目的）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第4条（利用目的の変更）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第5条（個人情報の第三者提供）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第6条（個人情報の開示）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第7条（個人情報の訂正および削除）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第8条（個人情報の利用停止等）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第9条（プライバシーポリシーの変更）</h2>
                <div class="c-text">
            ...
            <section class="c-section">
                <h2 class="c-heading">第10条（お問い合わせ窓口）</h2>
                <div class="c-text">
