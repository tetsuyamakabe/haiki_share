                ...
                <div class="p-product">
                    ...
                    <ul class="p-product--list">
                        ...
                        <li v-if="!products.data || products.data.length === 0" class="p-product__item">
                            <p class="c-text u-m__xl">出品した商品はありません。</p>
                        </li>
                        <!-- 出品した商品一覧を表示 -->
                        <li v-else v-for="product in products.data" :key="product.id" class="p-product__item">
                            ...
                            <div class="c-card">
                                ...
                                <div class="c-card__footer">
                                    ...
                                    <router-link v-if="!product.is_purchased" :to="getProductEditLink(product.id)" class="c-button c-button--default">編集する</router-link>
                                </div>
                            </div>
                        </li>
                    </ul>
