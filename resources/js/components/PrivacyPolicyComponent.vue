<template>
    <main class="l-container">
        <article class="l-main__wrapper l-main__wrapper--policy">
            <h1 class="c-title c-title__header u-mb__xl">プライバシーポリシー</h1>
            <div class="p-policy">

                <section class="u-pdt__m u-pdb__m">
                    <p>haiki share（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                </section>

                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第1条（個人情報）</h2>
                    <p>「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
                </section>

                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第2条（個人情報の収集方法）</h2>
                    <p>当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。</p>
                </section>

                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第3条（個人情報を収集・利用する目的）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第4条（利用目的の変更）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第5条（個人情報の第三者提供）</h2>
                    ...
                    <p>（5）本人の求めを受け付ける方法</p>
                    <p>5、前項の定めにかかわらず，次に掲げる場合には，当該情報の提供先は第三者に該当しないものとします。</p>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第6条（個人情報の開示）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第7条（個人情報の訂正および削除）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第8条（個人情報の利用停止等）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第9条（プライバシーポリシーの変更）</h2>
                ...
                <section class="u-pdt__m u-pdb__m">
                    <h2 class="c-title c-title__policy">第10条（お問い合わせ窓口）</h2>
                    <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
                    <p>Eメールアドレス：haikishare.com</p>
                </section>
