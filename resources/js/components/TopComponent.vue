<template>
    <main class="l-container">
            ...
            <section class="u-color__bg u-pd__xl u-pd__xl" id="about">
                <h2 class="c-title u-mb__xl">サービス概要</h2>
            ...
            <RouterLink class="c-button c-button__primary c-button__top u-pd__s" to="/products">出品されている商品を見てみる</RouterLink>

            <section class="" id="usage">
                <h2 class="c-title u-mt__xl u-mb__xl">利用方法</h2>
                <div class="c-container">
                    <div class="c-container__body">
                        <div class="c-panel__group c-panel__group--flex">
                            <div class="c-panel c-panel__border c-panel__user">
                                ...
                                <div class="c-panel__container">
                                    ...
                                    <div class="c-panel__content">
                                        ...
                                        <p>２．商品一覧から気になる商品を探す</p>
                                    </div>
                                    <div class="c-panel__content">
                                        <img :src="'/images/purchase.png'" alt="利用方法画像" class="c-panel__image c-panel__image--usage">
                                        <p>３．購入の意思が固まったら、商品詳細画面で購入ボタンを押す</p>
                                    </div>
                                    <div class="c-panel__content">
                                        <img :src="'/images/convenience.png'" alt="利用方法画像" class="c-panel__image c-panel__image--usage">
                                        <p>４．利用者はコンビニに商品を購入しに行く</p>
                                    </div>
                                </div>
                                <div class="c-panel__foot">
                                    <RouterLink class="c-button c-button__main c-button__register u-pd__s" to="/user/register">利用者ユーザー登録</RouterLink>
                                </div>
                            </div>
                            ...
                            <div class="c-panel c-panel__border c-panel__convenience">
                                ...
                                <div class="c-panel__container">
                                    ...
                                    <div class="c-panel__content">
                                        ...
                                        <p>３．「商品購入完了メール」というメール通知があれば、実際の商品を用意しておく</p>
                                    </div>
                                </div>
                                <div class="c-panel__foot">
                                    <RouterLink class="c-button c-button__main c-button__register u-pd__s" to="/convenience/register">コンビニユーザー登録</RouterLink>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="c-container">
                    <div class="c-container__contact">
                        <form @submit.prevent="submitForm" class="c-form">
                            ...
                            <input v-model="formData.name" id="name" type="name" class="c-input u-pd__s" :class="{ 'is-invalid': errors && errors.name }" autocomplete="name">
                            <!-- メールアドレス -->
                            ...
                            <input v-model="formData.email" id="email" type="email" class="c-input u-pd__s" :class="{ 'is-invalid': errors && errors.email }" autocomplete="email">
                            <!--お問い合わせ内容 -->
                            ...
                            <textarea v-model="formData.contact" maxlength="255" id="contact" type="text" class="c-textarea u-pd__s" cols="30" rows="10" @keyup="countCharacters" :class="{ 'is-invalid': errors && errors.contact }"></textarea>
                            <span class="c-textarea__count">{{ formData.contact.length }} / 255文字</span>
                            <!-- 送信ボタン -->
                            <button type="submit" class="c-button c-button__submit c-button__main u-pd__s u-mt__m">送信する</button>
                        </form>
                    </div>
                </div>
            </section>
