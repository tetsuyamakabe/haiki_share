...
Vue.component('user-login-component', require('./components/User/LoginComponent.vue').default);
Vue.component('convenience-login-component', require('./components/Convenience/LoginComponent.vue').default);
