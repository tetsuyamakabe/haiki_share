...
class UserProductController extends Controller
{
    ...
    public function purchaseProduct($productId)
    {
        try {
            ...
            return response()->json(['message' => '商品を購入できませんでした。'], 500);
        }
    }
    ...
    public function cancelProduct($productId)
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => '商品を購入キャンセルできませんでした。'], 500);
        }
    }
    ...
    public function likeProduct(Request $request, $productId)
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => '商品をお気に入り登録できませんでした。'], 500);
        }
    }
    ...
    public function unlikeProduct(Request $request, $productId)
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => '商品をお気に入り解除できませんでした。'], 500);
        }
    }
    ...
    public function getPurchasedProducts()
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => '購入した商品情報を取得できませんでした。'], 500);
        }
    }
    ...
    public function getLikedProducts()
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => 'お気に入り商品情報を取得できませんでした。'], 500);
        }
    }
    ...
    public function getPrefecture()
    {
        try {
            ...
            \Log::error('例外エラー: ' . $e->getMessage());
            return response()->json(['message' => '出品しているコンビニがある都道府県情報を取得できませんでした。'], 500);
        }
    }
}