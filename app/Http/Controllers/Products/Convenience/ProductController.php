...
class ProductController extends Controller
{
    ...
    public function createProduct(ProductSaleRequest $request)
    {
        try {
            ...
            if ($request->hasFile('product_picture')) {
                \Log::debug('product_pictureが処理されます');
    ...
    public function getConvenienceProducts(Request $request)
    {
        try {
            ...
            // 商品情報と関連付けられた商品画像の中からコンビニIDと一致する商品を20件取得
            $products = Product::with('pictures')->where('convenience_store_id', $convenience->id)->paginate(20);
